...
// src/ui/react-draggable-window.tsx
var DraggableWindowContext = (0, import_react.createContext)(void 0);
function useParentDims(getParent) {
  const [parentDims, setParentDims] = (0, import_react.useState)([1, 1]);
...
function Dragger(props) {
  const { pos, setPos, currentScaleFactors } = (0, import_react.useContext)(
    DraggableWindowContext
  );
  const elemRef = (0, import_react.useRef)(null);
  const [isHeld, setIsHeld] = (0, import_react.useState)(false);
  const tempPosRef = (0, import_react.useRef)([0, 0]);
  (0, import_react.useEffect)(() => {
    if (!isHeld) return;
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "dragger", ref: elemRef }, props.children);
}
export {
  DraggableWindow,
  Dragger,
